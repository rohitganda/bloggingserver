...
set "tests=add-table drop-table add-column drop-column alter-column add-foreign-key drop-foreign-key add-index drop-index combined embedded soft-add soft-delete version data template "
